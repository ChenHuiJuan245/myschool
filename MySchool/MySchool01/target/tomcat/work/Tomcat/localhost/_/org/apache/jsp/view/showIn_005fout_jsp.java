 ...
 * Generated at: 2018-05-28 07:22:25 UTC
...
public final class showIn_005fout_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 List<In_out_dorEntity> list= (List<In_out_dorEntity>) request.getAttribute("list");
      ...
      out.write("                <td>入住编号</td>\r\n");
      out.write("                <td>楼宇编号</td>\r\n");
      out.write("                <td>宿舍编号</td>\r\n");
      out.write("                <td>学号</td>\r\n");
      out.write("                <td>入住时间</td>\r\n");
      out.write("                <td>迁出时间</td>\r\n");
      out.write("                <td>调换楼宇</td>\r\n");
      out.write("                <td>调换宿舍</td>\r\n");
      out.write("                <td>操作</td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            ");
 for (In_out_dorEntity in:list){
      ...
      out.write("            <tr>\r\n");
      out.write("                <td>");
      out.print(in.getIn_id());
      out.write("</td>\r\n");
      out.write("                <td>");
      out.print(in.getB_id());
      out.write("</td>\r\n");
      out.write("                <td>");
      out.print(in.getD_id());
      out.write("</td>\r\n");
      out.write("                <td>");
      out.print(in.getS_id());
      out.write("</td>\r\n");
      out.write("                <td>");
      out.print(in.getIn_date());
      out.write("</td>\r\n");
      out.write("                <td>");
      out.print(in.getOut_date());
      out.write("</td>\r\n");
      out.write("                <td>");
      out.print(in.getTo_b_id());
      out.write("</td>\r\n");
      out.write("                <td>");
      out.print(in.getTo_d_id());
      out.write("</td>\r\n");
      out.write("                <td>\r\n");
      out.write("                    <a href=\"queryin_out.do?method=queryid&id=");
      out.print(in.getIn_id());
      out.write("\" style=\"text-decoration: none;\">迁出登记</a>\r\n");
      out.write("                </td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            ");
}
